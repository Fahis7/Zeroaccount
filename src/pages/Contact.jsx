...
export default function Contact() {
  ...
  const cardClass =
    "flex items-start gap-4 rounded-2xl border border-gray-200/80 bg-white/80 p-5 shadow-lg backdrop-blur-sm transition-shadow duration-300 hover:shadow-xl hover:shadow-accent/5 dark:border-white/10 dark:bg-[#1A1D22]/80 dark:shadow-2xl";
  const iconWrapClass =
    "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-accent/10 to-accent/5 text-accent-deep dark:from-accent/20 dark:to-accent/10 dark:text-accent";
    ...
    <>
      ...
      <section className="bg-surface py-24 dark:bg-[#0D0F12]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <ScrollReveal delay={0.15}>
              <div className={cardClass}>
                ...
                <div>
                  ...
                  <a href={whatsappLink} target="_blank" rel="noreferrer" className="mt-1 block text-sm font-medium text-ink dark:text-white">
                    +971 50 422 8440
                  </a>
                </div>
              </div>
          ...
          <ScrollReveal delay={0.25} className="mx-auto mt-6 max-w-5xl">
            <div className="h-72 overflow-hidden rounded-2xl border border-gray-200/80 shadow-lg dark:border-white/10 dark:shadow-2xl">
              <iframe
