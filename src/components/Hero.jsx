  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.span
          variants={item}
          className="inline-flex items-center gap-2 border-b-2 border-accent/60 pb-1 font-display text-xs font-semibold uppercase tracking-[0.15em] text-accent overflow-hidden relative shimmer-badge"
        >
          {t("home.hero.eyebrow")}
        </motion.span>
